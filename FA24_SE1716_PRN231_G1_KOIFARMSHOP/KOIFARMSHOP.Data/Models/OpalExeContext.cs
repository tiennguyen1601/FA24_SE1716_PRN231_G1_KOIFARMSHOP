...
public partial class OpalExeContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AnimalId).HasName("PK__Animals__A21A73271E85A11C");
        ...
        {
            entity.HasKey(e => e.AimageId).HasName("PK__AnimalIm__95341BED5B9BE48D");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A2BEF35629F");
        ...
        {
            entity.HasKey(e => e.ConsignmentId).HasName("PK__Consignm__2AB758630C05E0BB");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B869B24628");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Order__C3905BAF5A94E879");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D30CD61ACC9F");
        ...
        {
            entity.HasKey(e => e.OrderPromotionId).HasName("PK__OrderPro__CE84A0E14B8E0B13");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payment__9B556A582359518A");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6ED8F9691BA");
        ...
        {
            entity.HasKey(e => e.PimageId).HasName("PK__ProductI__218DDF19450FF604");
        ...
        {
            entity.HasKey(e => e.PromotionId).HasName("PK__Promotio__52C42F2F281E1E52");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__Staff__96D4AAF77494851F");
